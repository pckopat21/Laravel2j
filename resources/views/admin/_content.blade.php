                                            ...
                                            <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0 me-2">
                                                                <img src="{{asset('assets') }}/admin/images/users/avatar-1.jpg" alt="" class="avatar-xs rounded-circle shadow" />
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0 me-2">
                                                                <img src="{{asset('assets') }}/admin/images/users/avatar-2.jpg" alt="" class="avatar-xs rounded-circle shadow" />
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0 me-2">
                                                                <img src="{{asset('assets') }}/admin/images/users/avatar-3.jpg" alt="" class="avatar-xs rounded-circle shadow" />
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0 me-2">
                                                                <img src="{{asset('assets') }}/admin/images/users/avatar-4.jpg" alt="" class="avatar-xs rounded-circle shadow" />
                                                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <div class="flex-shrink-0 me-2">
                                                                <img src="{{asset('assets') }}/admin/images/users/avatar-6.jpg" alt="" class="avatar-xs rounded-circle shadow" />
                                                            </div>
                            ...
                            <div class="card-body p-0">
                                ...
                                <div data-simplebar style="max-height: 410px;" class="p-3 pt-0">
                                    <div class="acitivity-timeline acitivity-main">
                                        ...
                                        <div class="acitivity-item py-3 d-flex">
                                            <div class="flex-shrink-0">
                                                <img src="{{asset('assets') }}/admin/images/users/avatar-2.jpg" alt="" class="avatar-xs rounded-circle acitivity-avatar shadow">
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                        ...
                                        <div class="acitivity-item d-flex">
                                            <div class="flex-shrink-0">
                                                <img src="{{asset('assets') }}/admin/images/users/avatar-3.jpg" alt="" class="avatar-xs rounded-circle acitivity-avatar shadow" />
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="card border border-dashed shadow-none">
                                                    <div class="card-body">
                                                        <div class="d-flex">
                                                            <div class="flex-shrink-0">
                                                                <img src="{{asset('assets') }}/admin/images/users/avatar-3.jpg" alt="" class="avatar-sm rounded shadow">
                                                            </div>
                                                            <div class="flex-grow-1 ms-3">
                                                                <div>
                                            ...
                                            <div class="swiper-slide">
                                                <div class="card border border-dashed shadow-none">
                                                    <div class="card-body">
                                                        <div class="d-flex">
                                                            <div class="flex-shrink-0">
                                                                <img src="{{asset('assets') }}/admin/images/users/avatar-2.jpg" alt="" class="avatar-sm rounded shadow">
                                                            </div>
                                                            <div class="flex-grow-1 ms-3">
                                                                <div>
